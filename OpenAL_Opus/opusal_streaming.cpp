...
pkg-config opus --modversion --cflags --libs
1.1
-I/usr/include/opus  -lopus
$ pkg-config opusfile --modversion --cflags --libs
0.5
-I/usr/include/opus  -lopusfile  

$ gcc opusal_streaming.cpp -o opusal_streaming `pkg-config openal --cflags --libs` `pkg-config opusfile --cflags --libs`

$ gcc opusal_streaming.cpp -o opusal_streaming -I/usr/include/opus -lopenal -lopusfile 
 */
